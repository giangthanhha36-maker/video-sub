...
def embed_subtitles(
    ...
    # [THAY DOI] Luon tinh target_subtitle_width truoc (truoc day chi tinh khi font_size == 0),
    # vi ben duoi wrap_subtitle_text() luon can bien nay -> tranh loi NameError khi font_size != 0.
